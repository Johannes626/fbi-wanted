        ...
        <Container breakpoint="xxl" className="mx-auto" >
            <Row className="g-3 py-1">
                ...
                <Col key={fbiItem?.uid}>
                    ...
                    <Card.Body >
                    <Card.Title className={styles.customCardTitle}>{fbiItem?.title}</Card.Title> {/*needs more work: some of the title is not visible if title is more than two lines long*/}
                    ...
                    <Card.Footer className={styles.cardFooter}>
                        <Button className={styles.cardButton} name={fbiItem?.uid} onClick={handleCriminalCardClick} variant="dark">Learn More</Button>
                    </Card.Footer>
                    </Card.Body>
                    </Card>
                </Col>
