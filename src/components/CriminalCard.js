...
function CriminalCard({data, handleCriminalCardClick}) {
    
    

    const wantedIndividual = (data || []).map(fbiItem => 
        fbiItem?.isSelected && (
            <Col key={fbiItem?.uid}>
                ...
                <Card.Footer>
                    <Button name={fbiItem?.uid}onClick={handleCriminalCardClick} variant="dark">Learn More</Button>
                </Card.Footer>
                </Card.Body>
                </Card>
            </Col>
